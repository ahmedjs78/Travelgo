    ...
    return(
        ...
        <div className=" mt-[130px] flex items-center justify-center  w-[1120px] h-[645px]">
            ...
            <div className=" relative w-[920px] h-[100%] ">
                <div className=" z-[2] absolute top-[-280px] right-[-260px] " ><img className="max-w-none" src="src\assets\sectione\Vector(4).svg" /></div>
                <Swiper 
                    className="z-[3]"
                    style={{
                    ...
                    >
                        ...
                        <SwiperSlide className=" flex flex-col items-center justify-center  w-[920px] h-[645PX] " >Slide 2</SwiperSlide>
                        <SwiperSlide className=" flex flex-col items-center justify-center  w-[920px] h-[645PX] ">Slide 3</SwiperSlide>
                </Swiper>
            </div>
            <div className="z-[3]">
